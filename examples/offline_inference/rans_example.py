...
def main():
    ...
    parser.add_argument("model_path", type=str, help="Path to the compressed model folder")
    parser.add_argument("--prompt", type=str, default="The capital of Finland is", help="Input text")
    parser.add_argument("--max_tokens", type=int, default=50, help="Max output tokens")
    parser.add_argument("--temp", type=float, default=0.0, help="Temperature (0.0 = greedy)")
